  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col-sm-6">
        <div class="row">
          <div class="col-sm-12">
            <h6 class="produk">Produk</h6>
          </div>
          <div class="col-sm-6">
            <img src="../img/northsider/BIJI KOPI ARABICA ETHIOPIA SIDAMO NATURAL - 200GR1.jpg" class="img-thumbnail">
          </div>
          <div class="col-sm-6">
            <a href="">kopi arabika blue batak</a><br>
            <p>berat 200gr</p>
            <p>variasi bubuk</p>
