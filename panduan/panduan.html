...
<section class="tulis">
  <div class="container">
    <div class="row justify-content-center">
      <div class="col-sm">
        <h4 class="text-center">Cara Menikmati Kopi Saat mudik</h4>
        <P>saatnya mempersiapkan diri untuk mudik lebaran! Pakaian, transportasi, uang dan kopi! kopi adalah elemen yang tidak bisa dilewatkan oleh penikmat kopi dimanapun berada. ada beberapa cara untuk menikmati secangkir kopi hitam saat perjalanan pulang... </P>
      </div>
    </div>
  </div>
  <hr>
  ...
  <div class="container">
    <div class="row">
      <div class="col-sm-6">
        ...
        <a href=""><h5>Mengapa ketinggian menghasilkan rasa kopi yang berbeda?</h5></a>
        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
        tempor incididunt ut labore et dolore magna aliqu.<hr></p>
      </div>
      <div class="col-sm-6">
        <img src="../img/3.png" class="img-thumbnail">
        <a href=""><h5>5 kopi daerah yang harus anda coba saat traveling</h5></a>
        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
      ...
      <div class="col-sm-6">
        ...
        <a href=""><h5>Memilih waktu meminum kopi dibulan puasa</h5></a>
        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
        tempor incididunt ut labore et dolore magna aliqu.</p>
        <hr>
      </div>
      <div class="col-sm-6">
        <img src="../img/1.png" class="img-thumbnail">
        <a href=""><h5>chemex dan v60, sebuah selera dalam manual brew</h5></a>
        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
        tempor incididunt ut labore et dolore magna aliqu.</p>
        <hr>
      </div>
...
<section class="next">
  <div class="container">
   <div class="next2"> <a href="#">1</a></div>
   <div class="next2"> <a href="#">2</a></div>
   <div class="next2"> <a href="#">3</a></div>
   <div class="next2"> <a href="#">4</a></div>
   <div class="next2"> <a href="#">5</a></div>
   </div>
